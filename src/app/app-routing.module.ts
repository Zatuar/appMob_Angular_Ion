...
const routes: Routes = [
  ...
  { path: 'feedbacks/:Cid', loadChildren: () => import('./controller/feedbacks/feedback.module').then( m => m.FeedbackPageModule)},
  { path: 'finfo/:Fid', loadChildren: () => import('./controller/feedbacks/finfo/finfo.module').then( m => m.FinfoPageModule)},
  { path: 'fcreate/:Cid', loadChildren: () => import('./controller/feedbacks/fcreate/fcreate.module').then( m => m.FcreatePageModule)},
